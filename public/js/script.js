...
//                         alert(`Comment sent successfully! Thanks for your feedback, ${data.coName}.`);
...
//             })
//             .finally(() => {
//                 isSubmitting = false; // Reset flag after the fetch completes
//             });
//         });
//     } else {
        ...
        row.innerHTML = `
          ...
          <td>
            <div class="input-group">
                ...
                <input type="number" min="0" max="99" data-id="${coffee._id}" value="0" class="form-control form-control-lg" onchange="calculateTotal()" />
        ...
        row.innerHTML = `
          ...
          <td>
            <div class="input-group">
                ...
                <input type="number" min="0" max="99" data-id="${snack._id}" value="0" class="form-control form-control-lg" onchange="calculateTotal()" />
